...
from src.utils import LambdaLR
...
def main(
    ...
    optimizerG, lr_lambda=LambdaLR(epochs, epoch, decay).step
    )

    lr_scheduler_D = torch.optim.lr_scheduler.LambdaLR(
    optimizerD, lr_lambda=LambdaLR(epochs, epoch, decay).step
    )
